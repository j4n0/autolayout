...
/**
 Autolayout library to simplify yada yada.
 
 [This one](https://github.com/kean/Align/blob/master/Sources/Align.swift) is more expressive BUT,
 if Apple breaks it tomorrow I don’t want to depend on a third party fixing it or waste time myself.
...
public class AutoLayout
{
    ...
    private func enumerateSubViews() -> [String: UIView]
    {
        var views = [String: UIView]()
...
// fluent api? align(a.al.top, to: b.al.bottom), align(x.leading, to: y.trailing)
